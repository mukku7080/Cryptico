            ...
            >
                ...
                <Flex gap={5} direction={'column'}>
                    ...
                    <Flex flex={1} direction={'column'} gap={5} display={{ base: 'flex', xl: 'none' }}>
                        <Card h={{ md: '50px', lg: '50px', xl: '120px' }} w={'full'} borderRadius={5} bg={'transparent'} boxShadow={'none'} border={'1px solid rgba(128, 128, 128,0.1)'} direction={'row'} justifyContent={'start'} >

                            <Heading size={'lg'} display={'flex'} alignItems={'center'} px={4} > {tag}</Heading>
                            <Flex justify={'flex-end'} alignItems={'center'} flex={{ base: 1, md: 'auto' }} display={{ base: 'flex', md: 'flex', lg: 'none', xl: 'none' }} pr={{ base: '20px', sm: '20px', md: '20px', lg: '0px' }} gap={5} >
                    ...
                    <Flex gap={5}>
                        ...
                        <Flex flex={.4} direction={'column'} gap={5} display={{ base: 'none', md: 'flex' }} >
                            <Card h={{ md: '50px', lg: '50px', xl: '120px' }} borderRadius={5} bg={'transparent'} boxShadow={'none'} border={'1px solid rgba(128, 128, 128,0.1)'} direction={'row'} display={{ sm: 'none', xl: 'flex' }} justifyContent={'center'} >
