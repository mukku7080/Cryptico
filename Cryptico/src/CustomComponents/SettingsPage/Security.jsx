...
const Enable2FA = () => {
    ...
    return (
        <Flex direction={'column'} gap={5} p={4} border={'1px solid #dcdcdc'} borderRadius={5}>
            ...
            {/* Google Authy */}
            <Flex gap={2} bg={'#f5f7fa'} p={4} borderRadius={5} alignItems={{ base: 'start', md: 'center' }} cursor={'pointer'} direction={{ base: 'column', md: 'row' }} >
            ...
            <Flex gap={5} bg={'#f5f7fa'} p={4} borderRadius={5} alignItems={{ base: 'start', md: 'center' }} direction={{ base: 'column' }} >
