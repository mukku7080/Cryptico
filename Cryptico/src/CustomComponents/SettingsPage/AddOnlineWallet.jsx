...
import { Box, Button, Card, Flex, Heading, ButtonGroup, IconButton, Image, Modal, ModalContent, ModalOverlay, ModalHeader, ModalCloseButton, useDisclosure, ModalBody, FormControl, FormLabel, Input, ModalFooter, Select, Checkbox, useToast } from '@chakra-ui/react'
                ...
                {({ values, handleChange, handleBlur, handleSubmit, setFieldValue, touched, errors }) => (
                    <Modal isOpen={isOpen} onClose={onClose} size={{ base: 'xs', md: 'md', lg: 'lg' }}>
                        ...
                        <ModalContent as="form" onSubmit={handleSubmit}>
                            <ModalHeader bg="gray.50" fontSize="14px" color="gray" borderTopRadius={5}>
                                Add Online Wallet
                                <ModalCloseButton />
                            </ModalHeader>
                            ...
                            <ModalFooter bg="gray.50" justifyContent="space-between" borderBottomRadius={5}>
